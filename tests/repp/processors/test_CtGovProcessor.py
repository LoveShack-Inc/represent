...
def test_itShouldProcessARollCallPDFBlob():
    ...
    ('SIEGRIST', 'Y'), ('BORER', 'Y'), ('ROSARIO', 'Y'), ('UNKNOWN', 'Y'), ('SIMANSKI', 'Y'), 
    ...
    ('SRINIVASAN', 'Y'), ('UNKNOWN', 'Y'), ('SANTIAGO, H.', 'Y'), ('DUBITSKY', 'Y'), 
    ...
    ('JULESON-SCOPINO VACANT', 'Y'), ('LAVIELLE', 'Y'), ('GODFREY', 'Y'), ('LEMAR', 'Y'), 
    ('LEGEYT', 'Y'), ('LESSER', 'Y'), ('MACLACHLAN', 'Y'), ('LINEHAN', 'Y'), ('ACKERT', 'Y'), 
    ('MCCARTY, K.', 'Y'), ('BERGER', 'Y'), ('LOPES', 'Y'), ('BELSITO', 'Y'), ('MCGORTY, B.', 'Y'), 
    ('CANDELARIA, J.', 'Y'), ('MCCARTHY VAHEY', 'Y'), ('BETTS', 'Y'), ('UNKNOWN', 'Y'), 
    ('COOK', 'Y'), ('MCGEE', 'Y'), ('BOCCHINO', 'Y'), ('OHLER', 'Y'), ('GENTILE', 'Y'), 
    ('MILLER, P.B.', 'Y'), ('BOLINSKY', 'Y'), ('UNKNOWN', 'Y'), ('MORIN', 'Y'), ('MUSHINSKY', 'Y'), 
    ('BUCKBEE', 'Y'), ('PAVALOCK-', 'Y'), ('MORRIS', 'Y'), ('PAOLILLO', 'Y'), ('BYRON', 'Y'), 
